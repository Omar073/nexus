...
# 4. Create placeholder assets under assets/app_logos/
Write-Host "[4/8] Creating placeholder assets/app_logos assets..."
New-Item -ItemType Directory -Force -Path "$root\assets\app_logos" | Out-Null
...
if (-not (Test-Path "$root\assets\app_logos\app_icon_black.png")) {
    [System.IO.File]::WriteAllBytes("$root\assets\app_logos\app_icon_black.png", $pngBytes)
}
if (-not (Test-Path "$root\assets\app_logos\app_icon_white.png")) {
    [System.IO.File]::WriteAllBytes("$root\assets\app_logos\app_icon_white.png", $pngBytes)
}
if (-not (Test-Path "$root\assets\app_logos\app_name_black.jpg")) {
    [System.IO.File]::WriteAllBytes("$root\assets\app_logos\app_name_black.jpg", $jpegBytes)
}
if (-not (Test-Path "$root\assets\app_logos\app_name_white.jpg")) {
    [System.IO.File]::WriteAllBytes("$root\assets\app_logos\app_name_white.jpg", $jpegBytes)
}
Write-Host "  Done"
Write-Host ""

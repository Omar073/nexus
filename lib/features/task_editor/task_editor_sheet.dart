...
import 'package:nexus/features/task_editor/widgets/task_attribute_selectors.dart';
import 'package:nexus/features/task_editor/widgets/task_category_selector.dart';
import 'package:nexus/features/task_editor/widgets/task_editor_header.dart';
import 'package:nexus/features/task_editor/widgets/task_editor_inputs.dart';
import 'package:nexus/features/task_editor/widgets/task_quick_options.dart';
...
class _TaskEditorSheetState extends State<TaskEditorSheet> {
  ...
  void _save() async {
    ...
    if (widget.task == null) {
      ...
      task.startDate = _selectedStartDate;
      task.dueDate = dueDateTime;
      task.priorityEnum = _selectedPriority;
      task.difficultyEnum = _selectedDifficulty;
      task.recurringRuleEnum = _selectedRecurrence;
      task.categoryId = _selectedCategoryId;
      task.subcategoryId = _selectedSubcategoryId;

      await widget.controller.saveTask(task);
    }

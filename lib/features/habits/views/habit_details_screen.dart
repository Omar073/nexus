...
class HabitDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 13; i >= 0; i--) {
      ...
      final completed = controller.logs.any((l) => l.habitId == habitId && l.dayKey == key && l.completed);
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Current streak: $streak', style: Theme.of(context).textTheme.titleMedium),
